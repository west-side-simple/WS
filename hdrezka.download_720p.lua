...
-- http://onhdrezka-download.com/p/866-vnutri-igry-2019-hdrezka-studio
	...
	local search_home = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.cc\/\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/home.jpg" width = "210"></a>'
	local search_movies = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.cc/films\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/movies.jpg" width = "210"></a>'
	local search_tvshows = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.cc/series\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/tvshows.jpg" width = "210"></a>'
	local search_anime = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.cc/animation\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/anime.jpg" width = "210"></a>'
	local search_kids = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.cc/cartoons\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/kids.jpg" width = "210"></a>'
	...
	rezka_poisk = ' <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'#' .. title .. '\')"><img src="https://rezka.cc/apple-touch-icon.png" height="24" align="top"></a>'
	local cover = answer:match('<img src="([^"]+%.png)') or answer:match('<img src="([^"]+%.jpg)')
	cover_str = answer:match('<div class="si%-cover">(.-)</div>')
	if cover_str then cover_str = cover_str:gsub('%">', '\')">'):gsub('%/>', 'height="320">'):gsub('href=%"', 'href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'' .. host) end
...
-- Флаги стран
					        ...
					        country_flag = '<img src="simpleTVImage:./luaScr/user/westSide/country/' .. country_ID .. '.png" height="24" align="top">'
...
--------------
	...
	ishd = '<a href="simpleTVLua:m_simpleTV.Control.ExecuteAction(37) m_simpleTV.Control.ExecuteAction(63)"><img src="simpleTVImage:./luaScr/user/westSide/resolution/' .. ishd .. '.png" height="36" align="top"></a>'
	local retAdr
	...
	tab[i].InfoPanelDesc = '<html><body bgcolor="#434750" style="background-image: url(simpleTVImage:./luaScr/user/westSide/icons/BG02_720p.jpg);"><table width="99%"><tr><td style="padding: 10px 10px 5px; vertical-align: middle;">' .. cover_str ..
	'</td><td style="padding: 10px 5px 0px; color: #BBBBBB; vertical-align: middle;"><h5>' .. titul_rezka_tor .. titul_hevc .. titul_rezka .. ishd .. '</h5>' .. desc1 .. '</td></tr></table>' .. desc2 .. '</html>'
	...
	m_simpleTV.User.HDRezka.titleTab = tab
		...
		if m_simpleTV.User.paramScriptForSkin_buttonClose then
			tab.ExtButton1 = {ButtonEnable = true, ButtonImageCx = 30, ButtonImageCy= 30, ButtonImage = m_simpleTV.User.paramScriptForSkin_buttonClose, ButtonScript = 'OnMultiAddressCancel_HDRezka()'}
		else
	...
	tab[1].Id = 1
	tab[1].Name = title
	tab[1].InfoPanelDesc = '<html><body bgcolor="#434750" style="background-image: url(simpleTVImage:./luaScr/user/westSide/icons/BG02_720p.jpg);"><table width="99%"><tr><td style="padding: 10px 10px 5px; vertical-align: middle;">' .. cover_str ..
	'</td><td style="padding: 10px 5px 0px; color: #BBBBBB; vertical-align: middle;"><h5>' .. titul_rezka_tor .. titul_hevc .. titul_rezka .. ishd .. '</h5>' .. desc1 .. '</td></tr></table>' .. desc2 .. '</html>'
...
-------------
				...
				'\')"><center><img src="' .. logo_s .. '" height = "315" width = "210"></a><center><h5><font color=#00FA9A>' .. name_s ..
...
------------------
	...
	tab[1].Id = 1
	tab[1].Name = title
	tab[1].InfoPanelDesc = '<html><body bgcolor="#434750" style="background-image: url(simpleTVImage:./luaScr/user/westSide/icons/BG01_720p.png);"><table width="99%%"><tr><td colspan="4"><h3><center>' ..
	titul_rezka_tor .. titul_hevc .. ' <font color=#CD7F32><b>' .. data .. ' </b></font>' .. titul_rezka .. '</h3></td></tr>' .. start_search ..
	'</html><html><body bgcolor="#434750" style="background-image: url(simpleTVImage:./luaScr/user/westSide/icons/BG01_720p.png);">' .. page_str .. desc_s .. page_str .. '</html>'
	tab[1].InfoPanelDesc = tab[1].InfoPanelDesc:gsub('"', "\"")
