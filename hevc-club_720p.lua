-- видеоскрипт для сайта https://rips.club (11/09/20) v.3
...
-- а так же все ссылки с сайта плюс поиск
		...
		local search_home = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rips.club/search/?part=0&year=&cat=0&standard=0&bit=0&order=0&search=\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/home.jpg" width = "120"></a>'
		local search_movies = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rips.club/search/?part=1&year=&cat=0&standard=0&bit=0&order=0&search=\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/movies.jpg" width = "120"></a>'
		local search_tvshows = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rips.club/search/?part=2&year=&cat=0&standard=0&bit=0&order=0&search=\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/tvshows.jpg" width = "120"></a>'
		local search_music = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rips.club/search/?part=3&year=&cat=0&standard=0&bit=0&order=0&search=\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/music.jpg" width = "120"></a>'
		local search_kids = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rips.club/search/?part=0&year=&cat=15&standard=0&bit=0&order=0&search=\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/kids.jpg" width = "120"></a>'
...
-- Флаги стран
					        ...
					        country_flag = '<img src="' .. m_simpleTV.MainScriptDir .. 'user/westSide/country/' .. country_ID .. '.png" height="36" align="top">'
...
--конец блока флаги стран
				rezka_poisk = ' <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'#' .. name_rus .. '\')"><img src="https://rezka.cc/assets/images/favicon.ico" height="24" align="top"></a>'
...
-----------------------------------
	...
	t[1].Id = 1
	t[1].Name = name_rus
	t[1].InfoPanelDesc = '<html><body bgcolor="#434750" style="background-image: url(simpleTVImage:./luaScr/user/westSide/icons/BG02_720p.jpg);"><table width="720"><tr><td style="padding: 10px 10px 5px; vertical-align: middle;"><img src="' .. poster ..
	'" height="320"></td><td style="padding: 10px 5px 0px; color: #EBEBEB; vertical-align: middle;"><h5>' .. titul_rezka_tor .. titul_hevc .. titul_rezka .. '</h5>' .. desc1 .. reting_table .. '<h5><font color=#CD7F32>' .. alltime ..
	...
	'" height="80"> <img style="float:right;" src="' .. poster:gsub('-0', '-2') ..
	'" height="80"> <img style="float:right;" src="' .. poster:gsub('-0', '-3') ..
	'" height="80"> <img style="float:right;" src="' .. poster:gsub('-0', '-4') ..
	'" height="80"> </td></tr></table><table width="720"><tr><td style="padding: 0px 10px 5px; color: #EBEBEB; vertical-align: middle;"><h5>'.. desc2 .. 	'</h5><h5>' .. desc .. '</h5></td></tr></table></html>'
	...
	t[1].InfoPanelLogo = poster:gsub('-0', '-1')
		...
		if m_simpleTV.User.paramScriptForSkin_buttonClose then
			t.ExtButton1 = {ButtonEnable = true, ButtonImageCx = 30, ButtonImageCy= 30, ButtonImage = m_simpleTV.User.paramScriptForSkin_buttonClose, ButtonScript = 'OnMultiAddressCancel_hevcClub()'}
		else
		...
		if m_simpleTV.User.paramScriptForSkin_buttonPlst then
			t.ExtButton0 = {ButtonEnable = true, ButtonImageCx = 30, ButtonImageCy= 30, ButtonImage = m_simpleTV.User.paramScriptForSkin_buttonPlst, ButtonScript = 'm_simpleTV.Control.ExecuteAction(116)'}
		else
...
--конец блока флаги стран
				...
				if genres ~= '' then titledesc = titledesc .. genres end
					...
					tab[i].InfoPanelDesc = '<html><body bgcolor="#434750" style="background-image: url(simpleTVImage:./luaScr/user/westSide/icons/BG02_720p.jpg);"><table width="720"><tr><td style="padding: 10px 10px 5px; vertical-align: middle;"><img src="' .. poster ..
	'" height="320"></td><td style="padding: 10px 5px 0px; color: #EBEBEB; vertical-align: middle;"><h5>' .. titul_rezka_tor .. titul_hevc .. titul_rezka .. '</h5>' .. desc1 .. '<h5><font color=#CD7F32>' .. alltime ..
	'</font><a href="simpleTVLua:m_simpleTV.Control.ExecuteAction(37) m_simpleTV.Control.ExecuteAction(116)" style="color:#009B76; font-size: small; text-decoration:none"> 🕜 ГЛАВЫ</a></h5>' ..
	'</td><td style="padding: 10px 10px 5px; vertical-align: middle;"><img style="float:right;" src="' .. poster:gsub('-0', '-1') ..
	'" height="80"> <img style="float:right;" src="' .. poster:gsub('-0', '-2') ..
	'" height="80"> <img style="float:right;" src="' .. poster:gsub('-0', '-3') ..
	...
	tab[i].InfoPanelLogo = poster:gsub('-0', '-1')
		...
		if m_simpleTV.User.paramScriptForSkin_buttonClose then
			tab.ExtButton1 = {ButtonEnable = true, ButtonImageCx = 30, ButtonImageCy= 30, ButtonImage = m_simpleTV.User.paramScriptForSkin_buttonClose, ButtonScript = 'OnMultiAddressCancel_hevcClub()'}
		else
			tab.ExtButton1 = {ButtonEnable = true, ButtonName = '✕', ButtonScript = 'OnMultiAddressCancel_hevcClub()'}
		end
		if m_simpleTV.User.paramScriptForSkin_buttonPlst then
			tab.ExtButton0 = {ButtonEnable = true, ButtonImageCx = 30, ButtonImageCy= 30, ButtonImage = m_simpleTV.User.paramScriptForSkin_buttonPlst, ButtonScript = 'm_simpleTV.Control.ExecuteAction(116)'}
		else
...
-- Флаги стран
                            local function get_country_flags(country_ID)
					        country_flag = '<img src="' .. m_simpleTV.MainScriptDir .. 'user/westSide/country/' .. country_ID .. '.png" height="54" align="top">'
					        return country_flag:gsub('"', "'")
							end
							local tmp_country_ID = ''
							country_ID = ''
...
-----------------------------------
		...
		answer_files = answer_files:gsub('<li>cover.png.-</li>', '')
				...
				episode = w:gsub('&nbsp;', ' '):gsub('<b>', ''):gsub('</b>', ''):gsub('%.E', 'E')
					...
					t[i].InfoPanelDesc = '<html><body bgcolor="#434750" style="background-image: url(simpleTVImage:./luaScr/user/westSide/icons/BG02_720p.jpg);"><table width="720"><tr><td style="padding: 10px 10px 5px; vertical-align: middle;"><img src="' .. poster ..
	'" height="320"></td><td style="padding: 10px 5px 0px; color: #EBEBEB; vertical-align: middle;"><h5>' ..titul_rezka_tor .. titul_rezka .. titul_hevc .. '</h5>' .. desc1 .. '<h5><font color=#CD7F32>' .. alltime ..
	'</font><a href="simpleTVLua:m_simpleTV.Control.ExecuteAction(37) m_simpleTV.Control.ExecuteAction(116)" style="color:#009B76; font-size: small; text-decoration:none"> 🕜 ГЛАВЫ</a></h5>' ..
	'</td><td style="padding: 10px 10px 5px; vertical-align: middle;"><img style="float:right;" src="' .. poster:gsub('-0', '-1') ..
	'" height="80"> <img style="float:right;" src="' .. poster:gsub('-0', '-2') ..
	'" height="80"> <img style="float:right;" src="' .. poster:gsub('-0', '-3') ..
...
--конец блока флаги стран
				...
				'\')"><img src="' .. t[i].desc_logo .. '" height = "250"></a></td><td style="padding: 20px 5px 0px; color: #EBEBEB; vertical-align: middle;"><h4><font color=#00FA9A>' .. name_rus ..
				'</font></h4><h5><font color=#BBBBBB>' .. name_eng .. '</h5>' .. desc1 .. '</td></tr></table><table width="99%"><tr><td style="padding: 10px 0px 5px; color: #EEEEEE; vertical-align: middle;"><h5>' .. desc .. '</h5></td></tr></table>'
...
------------------
	...
	'\')"><img src="' .. logo_top .. '" height = "180" width = "120"></a></td>' end
...
local tab_zapros = {}
		...
		tab_zapros[1].InfoPanelDesc = '<html><body bgcolor="#434750" style="background-image: url(simpleTVImage:./luaScr/user/westSide/icons/BG01_720p.png);"><table width="99%%"><tr><td colspan="5"><h3><center>' .. titul_rezka_tor .. titul_hevc .. ' <font color=#CD7F32><b>' .. data .. ' </b></font>' .. titul_rezka .. '</h3></td></tr>' .. start_search .. desc_top .. '</html><html><body bgcolor="#434750" style="background-image: url(simpleTVImage:./luaScr/user/westSide/icons/BG01_720p.png);">' .. page_str .. desc_zapros .. page_str .. '</html>'
		tab_zapros[1].InfoPanelDesc = tab_zapros[1].InfoPanelDesc:gsub('"', '\"')
		tab_zapros[1].InfoPanelTitle = tab_zapros[1].InfoPanelTitle:gsub('"', '\"')

		if m_simpleTV.User.paramScriptForSkin_buttonOk then
			tab_zapros.OkButton = {ButtonImageCx = 30, ButtonImageCy= 30, ButtonImage = m_simpleTV.User.paramScriptForSkin_buttonOk}
		end
		if m_simpleTV.User.paramScriptForSkin_buttonClose then
			tab_zapros.ExtButton1 = {ButtonEnable = true, ButtonImageCx = 30, ButtonImageCy= 30, ButtonImage = m_simpleTV.User.paramScriptForSkin_buttonClose, ButtonScript = 'OnMultiAddressCancel_hevcClub()'}
		else
