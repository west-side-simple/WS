-- видеоскрипт для сайта https://rezka.ag (11/09/20) v.2.3
...
-- <<>>
	...
	local titul_hevc = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rips.club\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/h265.png" height="24" align="top"></a>'
	local titul_rezka_tor = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.cc\/\')"><img src="https://rezka.cc/apple-touch-icon.png" height="24" align="top"></a>'
...
------------------
	...
	local titul_rezka = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag\')"><img src="https://rezka.ag/templates/hdrezka/images/hdrezka-logo.png" height="24" align="top"></a>'
	local titul_page = '🔶 <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag/films/\')" style="color: #BBBBBB; text-decoration: none;">фильмы</a><br>' ..
	                   '🔶 <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag/films/?filter=popular\')" style="color: #BBBBBB; text-decoration: none;">фильмы | популярные</a><br>' ..
					   '🔶 <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag/films/?filter=watching\')" style="color: #BBBBBB; text-decoration: none;">фильмы | сейчас смотрят</a><br>' ..
					   '🔶 <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag/series/\')" style="color: #BBBBBB; text-decoration: none;">сериалы</a><br>' ..
	                   '🔶 <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag/series/?filter=popular\')" style="color: #BBBBBB; text-decoration: none;">сериалы | популярные</a><br>' ..
					   '🔶 <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag/series/?filter=watching\')" style="color: #BBBBBB; text-decoration: none;">сериалы | сейчас смотрят</a><br>' ..
					   '🔶 <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag/cartoons/\')" style="color: #BBBBBB; text-decoration: none;">мультфильмы</a><br>' ..
	                   '🔶 <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag/cartoons/?filter=popular\')" style="color: #BBBBBB; text-decoration: none;">мультфильмы | популярные</a><br>' ..
					   '🔶 <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag/cartoons/?filter=watching\')" style="color: #BBBBBB; text-decoration: none;">мультфильмы | сейчас смотрят</a><br>' ..
					   '🔶 <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag/animation/\')" style="color: #BBBBBB; text-decoration: none;">аниме</a><br>' ..
	                   '🔶 <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag/animation/?filter=popular\')" style="color: #BBBBBB; text-decoration: none;">аниме | популярные</a><br>' ..
					   '🔶 <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag/animation/?filter=watching\')" style="color: #BBBBBB; text-decoration: none;">аниме | сейчас смотрят</a><br>' ..
					   '🔷 <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag/franchises/\')" style="color: #BBBBBB; text-decoration: none;">Лучшие франшизы</a><br>' ..
					   '🔷 <a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag/collections/\')" style="color: #BBBBBB; text-decoration: none;">Лучшие подборки</a><br>'
	...
	then t_rezka = ''
	else t_rezka = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'' .. t_rezka .. '\')"><img src="https://rezka.cc/assets/images/favicon.ico" height="24" align="top"></a>'
	end
	if answer:match('<h2>В качестве</h2>') then poisk_kinopoisk = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'*' .. name_rus .. '\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/menuKP.png" height="24" align="top"></a>' else poisk_kinopoisk = '' end
	if answer:match('<h2>В качестве</h2>') then poisk_youtube = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'-' .. name_rus .. '\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/menuYT.png" height="24" align="top"></a>' else poisk_youtube = '' end
...
------------------
	...
	if genres_str == '' then genres_str = titul_page end
	local reting = ''
	...
	if reting_kp ~= '' then
	reting = reting .. '<h5><b><img src="simpleTVImage:./luaScr/user/westSide/icons/menuKP.png" height="20" align="top"><img src="simpleTVImage:./luaScr/user/westSide/stars/' .. reting_kp .. '.png" height="20" align="top"> ' .. vote_kp .. '</b></h5>'
	end
	if reting_imdb ~= '' then
	reting = reting .. '<h5><b><img src="simpleTVImage:./luaScr/user/westSide/icons/menuIMDb.png" height="20" align="top"><img src="simpleTVImage:./luaScr/user/westSide/stars/' .. reting_imdb .. '.png" height="20" align="top"> ' .. vote_imdb .. '</b></h5>'
	end
	if reting_rezka ~= '' then
	reting = reting .. '<h5><b><img src="https://rezka.cc/assets/images/favicon.ico" height="20" align="top"><img src="simpleTVImage:./luaScr/user/westSide/stars/' .. reting_rezka .. '.png" height="20" align="top"> ' .. vote_rezka .. '</b></h5>'
	end
...
------------------content plus
	...
	for w in answer:gmatch('<div class="b%-content__inline_item.-"(.-</div>) </div></div>') do
				...
				'\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/menuKP.png" height="24" align="top"></a><img src="simpleTVImage:./luaScr/user/westSide/stars/' .. rating_strc .. '.png" height="24" align="top"></h5>'
				else rating_strc = ''
				end
...
------------------
				...
				'\')"><center><img src="' .. logoc .. '" height = "315" width = "210"></a><center>' .. rating_strc .. '<h5><font color=#00FA9A>' .. iscontent .. namec .. '</font></h5><h5><font color=#CD7F32>' .. yearc .. ' </font>'.. country_ID .. ' <font color=#BBBBBB>' .. genrec ..'</h5></td>'
				end
...
------------------
	...
	for w in answer:gmatch('<div class="b%-content__collections_item"(.-) </div></div>') do
				...
				'\')"><center><img src="' .. logos .. '" height = "120" width = "208"></a><center><h5><font color=#00FA9A>' .. names ..
	...
	if not tabw or not tabw.content then return end
		...
		tw[jw] = {}
			...
			then tw[jw].genres_w = tabw.content[jw].genres[1].name:gsub('%/', ', ')
				...
				rating_strw = '<h5><img src="simpleTVImage:./luaScr/user/westSide/icons/menuWINK.png" height="24" align="top"><img src="simpleTVImage:./luaScr/user/westSide/stars/' .. rating_strw .. '.png" height="24" align="top"></h5>'
				else rating_strw = ''
				end
			...
			tw[jw].country_ID = country_ID
				...
				year = year:gsub('%- %.%.%.', '')
				if tw[jw].yearw and year and tw[jw].yearw == year then				
				y_wink = '1' else y_wink = '0' end
				if tw[jw].yearw and year and tw[jw].yearw ~= '' and year  ~= '' and math.abs(tonumber(tw[jw].yearw) - tonumber(year)) == 1
...
--		table.sort(tw1, function(c, d) return c.inw > d.inw end)
	...
	zapros_wink0:gsub('%%2B', '+') .. '</font><br> индекс совпадения: <font color=#CD7F32>' .. inw .. '</font></h3></td></tr></table><table width="99%"><tr>'
			...
			if jkw == 5 then
				...
				'\')"><center><img src="' .. tw1[i].posterw .. '" height = "315" width = "210"></a><center>' .. tw1[i].rating_strw .. '<h5><font color=#00FA9A>' .. tw1[i].iscontentw .. tw1[i].namew ..
...
------------------конец блока WINK
	...
	if serial then
			...
			for w in answer0:gmatch('<li class="b%-simple_episode__item.-</li>') do
				...
				if data_id and season_id and episode_id then
					...
					t[i].Address = string.format('$rezkaid=%s&translator_id=%s&season=%s&episode=%s'
								...
								, season_id
								, episode_id)
					t[i].InfoPanelDesc = '<html><body bgcolor="#434750" style="background-image: url(simpleTVImage:./luaScr/user/westSide/icons/BG01_720p.png);"><table width="99%"><tr><td style="padding: 10px 10px 5px; vertical-align: middle;"><img src="' .. poster ..
					'" width="300"></td><td style="padding: 0px 5px 10px; color: #EBEBEB; vertical-align: middle;" width="270">' .. str_poisk .. '<h5><i><font color=#EBEBEB>' .. slogan .. '</font></i>  <b><font color=#CD7F32>' .. mpaa .. '</font></b></h5><h4><font color=#00FA9A>' .. name_rus .. '</font></h4><h5><font color=#BBBBBB>' .. name_eng ..
	 ...
	 return
		...
		t[1].InfoPanelDesc = '<html><body bgcolor="#434750" style="background-image: url(simpleTVImage:./luaScr/user/westSide/icons/BG01_720p.png);"><table width="99%"><tr><td style="padding: 10px 10px 5px; vertical-align: middle;"><img src="' .. poster ..
		'" width="300"></td><td style="padding: 0px 5px 10px; color: #EBEBEB; vertical-align: middle;" width="270">' .. str_poisk .. '<h5><i><font color=#EBEBEB>' .. slogan .. '</font></i>  <b><font color=#CD7F32>' .. mpaa .. '</font></b></h5><h4><font color=#00FA9A>' .. name_rus .. '</font></h4><h5><font color=#BBBBBB>' .. name_eng ..
		'<h5>' .. country_ID .. ' ' .. countryr .. ' <font color=#CD7F32>' .. year .. '</font></h5><h5><font color=#BBBBBB>' .. genres_str .. '</font></h5>' .. reting .. time_all .. '</td>' .. desc_top ..
		'</tr></table>' .. table_person .. table_sp .. frn_str .. table_desc .. '<table width="99%"><tr>' .. desc1 .. '</tr></table><table width="99%"><tr>' .. desc2 .. '</tr></table>' .. desck .. '</tr></table>' .. descs .. '</tr></table>' .. wink_str .. '</tr></table>' .. page_str .. '</html>'
