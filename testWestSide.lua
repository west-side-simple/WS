...
--	else return
		...
		local titul_wink = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'##\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/menuWINK.png" height="' .. 36*masshtab .. '" align="top"></a>'
	...
	if Weather then
		...
		if type(pogoda)=="table" then
			...
			pogoda_str = '<td style="padding: 10px 10px 5px; vertical-align: middle; color: #EBEBEB;"><h3><img src="' .. pogoda_cur_icon .. '" height="' .. 36*masshtab .. '" align="top">' ..	pogoda_cur_temp .. pogoda_letter .. '</h3></td>'
	...
	portal_str = '<table width="' .. 660*masshtab .. '"><tr><td style="padding: 10px 10px 5px; vertical-align: middle;"><h3><center>' ..
...
t.MediaMode =  3 --opt default -1 (-1 all, 0 - channels, 1 - files, etc)
