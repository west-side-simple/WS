...
-----------------------------------
	...
	'" height="120"> <img style="float:right;" src="' .. poster:gsub('-0', '-3') ..
	'" height="120"> <img style="float:right;" src="' .. poster:gsub('-0', '-4') ..
	'" height="120"> </td></tr></table><table width="1080"><tr><td style="padding: 0px 10px 5px; color: #EBEBEB; vertical-align: middle;"><h5>'.. desc2 .. 	'</h5><h5>' .. desc .. '</h5></td></tr></table></html>'
	...
	t[1].InfoPanelLogo = poster:gsub('-0', '-1')
		...
		if m_simpleTV.User.paramScriptForSkin_buttonClose then
			t.ExtButton1 = {ButtonEnable = true, ButtonImageCx = 45, ButtonImageCy= 45, ButtonImage = m_simpleTV.User.paramScriptForSkin_buttonClose, ButtonScript = 'OnMultiAddressCancel_hevcClub()'}
		else
		...
		if m_simpleTV.User.paramScriptForSkin_buttonPlst then
			t.ExtButton0 = {ButtonEnable = true, ButtonImageCx = 45, ButtonImageCy= 45, ButtonImage = m_simpleTV.User.paramScriptForSkin_buttonPlst, ButtonScript = 'm_simpleTV.Control.ExecuteAction(116)'}
		else
...
--конец блока флаги стран
	...
	tab[i].InfoPanelLogo = poster:gsub('-0', '-1')
		...
		if m_simpleTV.User.paramScriptForSkin_buttonClose then
			tab.ExtButton1 = {ButtonEnable = true, ButtonImageCx = 45, ButtonImageCy= 45, ButtonImage = m_simpleTV.User.paramScriptForSkin_buttonClose, ButtonScript = 'OnMultiAddressCancel_hevcClub()'}
		else
			tab.ExtButton1 = {ButtonEnable = true, ButtonName = '✕', ButtonScript = 'OnMultiAddressCancel_hevcClub()'}
		end
		if m_simpleTV.User.paramScriptForSkin_buttonPlst then
			tab.ExtButton0 = {ButtonEnable = true, ButtonImageCx = 45, ButtonImageCy= 45, ButtonImage = m_simpleTV.User.paramScriptForSkin_buttonPlst, ButtonScript = 'm_simpleTV.Control.ExecuteAction(116)'}
		else
...
--конец блока флаги стран
				...
				'\')"><img src="' .. t[i].desc_logo .. '" height = "375"></a></td><td style="padding: 20px 5px 0px; color: #EBEBEB; vertical-align: middle;"><h4><font color=#00FA9A>' .. name_rus ..
...
local tab_zapros = {}
		...
		if m_simpleTV.User.paramScriptForSkin_buttonOk then
			tab_zapros.OkButton = {ButtonImageCx = 45, ButtonImageCy= 45, ButtonImage = m_simpleTV.User.paramScriptForSkin_buttonOk}
		end
		if m_simpleTV.User.paramScriptForSkin_buttonClose then
			tab_zapros.ExtButton1 = {ButtonEnable = true, ButtonImageCx = 45, ButtonImageCy= 45, ButtonImage = m_simpleTV.User.paramScriptForSkin_buttonClose, ButtonScript = 'OnMultiAddressCancel_hevcClub()'}
		else
