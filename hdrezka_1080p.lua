...
-- <<>>
	...
	function Qlty_rezka()
		...
		if m_simpleTV.User.paramScriptForSkin_buttonClose then
			t.ExtButton1 = {ButtonEnable = true, ButtonImageCx = 45, ButtonImageCy= 45, ButtonImage = m_simpleTV.User.paramScriptForSkin_buttonClose}
		else
...
------------------
	...
	local titul_rezka = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'https://rezka.ag\')"><img src="https://rezka.ag/templates/hdrezka/images/hdrezka-logo.png" height="36" align="top"></a>'
	...
	then t_rezka = ''
	else t_rezka = '<a href = "simpleTVLua:m_simpleTV.Control.PlayAddress(\'' .. t_rezka .. '\')"><img src="https://rezka.cc/assets/images/favicon.ico" height="36" align="top"></a>'
	end
...
------------------
	...
	if reting_kp ~= '' then
	reting = reting .. '<h5><b><img src="simpleTVImage:./luaScr/user/westSide/icons/menuKP.png" height="30" align="top"><img src="simpleTVImage:./luaScr/user/westSide/stars/' .. reting_kp .. '.png" height="30" align="top"> ' .. vote_kp .. '</b></h5>'
	end
	if reting_imdb ~= '' then
	reting = reting .. '<h5><b><img src="simpleTVImage:./luaScr/user/westSide/icons/menuIMDb.png" height="30" align="top"><img src="simpleTVImage:./luaScr/user/westSide/stars/' .. reting_imdb .. '.png" height="30" align="top"> ' .. vote_imdb .. '</b></h5>'
	end
	if reting_rezka ~= '' then
	reting = reting .. '<h5><b><img src="https://rezka.cc/assets/images/favicon.ico" height="30" align="top"><img src="simpleTVImage:./luaScr/user/westSide/stars/' .. reting_rezka .. '.png" height="30" align="top"> ' .. vote_rezka .. '</b></h5>'
	end
...
------------------content plus
	...
	for w in answer:gmatch('<div class="b%-content__inline_item.-"(.-</div>) </div></div>') do
				...
				'\')"><img src="simpleTVImage:./luaScr/user/westSide/icons/menuKP.png" height="36" align="top"></a><img src="simpleTVImage:./luaScr/user/westSide/stars/' .. rating_strc .. '.png" height="36" align="top"></h5>'
				else rating_strc = ''
				end
...
------------------
				...
				'\')"><center><img src="' .. logoc .. '" height = "480" width = "320"></a><center>' .. rating_strc .. '<h5><font color=#00FA9A>' .. iscontent .. namec .. '</font></h5><h5><font color=#CD7F32>' .. yearc .. ' </font>'.. country_ID .. ' <font color=#BBBBBB>' .. genrec ..'</h5></td>'
				end
...
------------------
	...
	for w in answer:gmatch('<div class="b%-content__collections_item"(.-) </div></div>') do
				...
				'\')"><center><img src="' .. logos .. '" height = "180" width = "320"></a><center><h5><font color=#00FA9A>' .. names ..
	...
	if not tabw or not tabw.content then return end
		...
		tw[jw] = {}
			...
			then tw[jw].genres_w = tabw.content[jw].genres[1].name:gsub('%/', ', ')
				...
				rating_strw = '<h5><img src="simpleTVImage:./luaScr/user/westSide/icons/menuWINK.png" height="36" align="top"><img src="simpleTVImage:./luaScr/user/westSide/stars/' .. rating_strw .. '.png" height="36" align="top"></h5>'
				else rating_strw = ''
				end
...
--		table.sort(tw1, function(c, d) return c.inw > d.inw end)
	...
	zapros_wink0:gsub('%%2B', '+') .. '</font><br> индекс совпадения: <font color=#CD7F32>' .. inw .. '</font></h3></td></tr></table><table width="99%"><tr>'
			...
			if jkw == 5 then
				...
				'\')"><center><img src="' .. tw1[i].posterw .. '" height = "480" width = "320"></a><center>' .. tw1[i].rating_strw .. '<h5><font color=#00FA9A>' .. tw1[i].iscontentw .. tw1[i].namew ..
...
------------------конец блока WINK
	...
	if serial then
			...
			for w in answer0:gmatch('<li class="b%-simple_episode__item.-</li>') do
				...
				if data_id and season_id and episode_id then
					...
					t[i].Address = string.format('$rezkaid=%s&translator_id=%s&season=%s&episode=%s'
								...
								, season_id
								, episode_id)
					t[i].InfoPanelDesc = '<html><body bgcolor="#434750" style="background-image: url(simpleTVImage:./luaScr/user/westSide/icons/BG01_1080p.png);"><table width="99%"><tr><td style="padding: 10px 10px 5px; vertical-align: middle;"><img src="' .. poster ..
					'" width="450"></td><td style="padding: 0px 5px 10px; color: #EBEBEB; vertical-align: middle;" width="400">' .. str_poisk .. '<h5><i><font color=#EBEBEB>' .. slogan .. '</font></i>  <b><font color=#CD7F32>' .. mpaa .. '</font></b></h5><h4><font color=#00FA9A>' .. name_rus .. '</font></h4><h5><font color=#BBBBBB>' .. name_eng ..
		...
		if m_simpleTV.User.paramScriptForSkin_buttonOptions then
			t.ExtButton0 = {ButtonEnable = true, ButtonImageCx = 45, ButtonImageCy= 45, ButtonImage = m_simpleTV.User.paramScriptForSkin_buttonOptions, ButtonScript = 'Qlty_rezka()'}
		else
	 ...
	 return
		...
		t[1].InfoPanelDesc = '<html><body bgcolor="#434750" style="background-image: url(simpleTVImage:./luaScr/user/westSide/icons/BG01_1080p.png);"><table width="99%"><tr><td style="padding: 10px 10px 5px; vertical-align: middle;"><img src="' .. poster ..
		'" width="450"></td><td style="padding: 0px 5px 10px; color: #EBEBEB; vertical-align: middle;" width="400">' .. str_poisk .. '<h5><i><font color=#EBEBEB>' .. slogan .. '</font></i>  <b><font color=#CD7F32>' .. mpaa .. '</font></b></h5><h4><font color=#00FA9A>' .. name_rus .. '</font></h4><h5><font color=#BBBBBB>' .. name_eng ..
		'<h5>' .. country_ID .. ' ' .. countryr .. ' <font color=#CD7F32>' .. year .. '</font></h5><h5><font color=#BBBBBB>' .. genres_str .. '</font></h5>' .. reting .. time_all .. '</td>' .. desc_top ..
