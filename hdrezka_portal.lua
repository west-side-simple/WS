...
------------------
	...
	local t_rezka = answer:match('<a class="b%-post__status__tracker__download" href="(.-)" target="') or ''
		...
		local data_id, season_id, episode_id
			for w in answer0:gmatch('<li class="b%-simple_episode__item.-</li>') do
				...
				if data_id and season_id and episode_id then
					...
					'" width="' .. masshtab*300 .. '"></td><td style="padding: 0px 5px 10px; color: #EBEBEB; vertical-align: middle;" width="' .. masshtab*266 .. '"><h3>' .. titul_rezka_tor .. titul_hevc .. titul_lostfilm .. titul_yt .. titul_rezka .. titul_wink .. 
					'</h3><hr><h5><i><font color=#EBEBEB>' .. slogan .. '</font></i>  <b><font color=#CD7F32>' .. mpaa .. '</font></b></h5><h4><font color=#00FA9A>' .. name_rus .. '</font></h4><h4>' .. str_poisk .. '</h4><h5><font color=#BBBBBB>' .. name_eng ..
...
------------------ 
	 ...
	 return
		...
		local t = {}
		if inAdr ~= background_chanel then portal_str = '' else portal1_str = '' end
		t[1] = {}
		t[1].Id = 1
		t[1].Name = title
		...
		'" width="' .. masshtab*300 .. '"></td><td style="padding: 0px 5px 10px; color: #EBEBEB; vertical-align: middle;" width="' .. masshtab*266 .. '">' .. portal1_str .. '<h5><i><font color=#EBEBEB>' .. slogan .. '</font></i>  <b><font color=#CD7F32>' .. mpaa .. '</font></b></h5><h4><font color=#00FA9A>' .. name_rus .. '</font></h4><h4>' .. str_poisk .. '</h4><h5><font color=#BBBBBB>' .. name_eng ..
		'<h5>' .. country_ID .. ' ' .. countryr .. ' <font color=#CD7F32>' .. year .. '</font></h5><h5><font color=#BBBBBB>' .. genres_str .. '</font></h5>' .. reting .. time_all .. '</td>' .. desc_top ..
