...
--		 return
	...
	poster1 = poster
	if m_simpleTV.Control.MainMode == 0 then
	if poster == poster_hevc or poster == 'https://rips.club/img/header.png'then
...
--конец блока флаги стран
				...
				'</font></h4><h5><font color=#BBBBBB>' .. name_eng .. '</h5>' .. desc1 .. '</td></tr></table><table width="99\%"><tr><td style="padding: 10px 0px 5px; color: #EEEEEE; vertical-align: middle;"><h5>' .. desc .. '</h5></td></tr></table><hr>'
...
local tab_zapros = {}
	    ...
	    tab_zapros[1].InfoPanelLogo = 'https://rips.club/img/header.png'
		tab_zapros[1].InfoPanelDesc = '<html><body bgcolor="#434750" ' .. background1 .. '>' .. portal_str .. '<table>' .. start_search .. desc_top .. '</html><html><body bgcolor="#434750" ' .. background1 .. '>' .. page_str .. desc_zapros .. page_str .. '</html>'
